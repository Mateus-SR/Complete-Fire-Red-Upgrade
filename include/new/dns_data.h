...
//Change These
//Overworld Palettes
#define OW_BG_PAL_0 FALSE
#define OW_BG_PAL_1 FALSE
#define OW_BG_PAL_2 FALSE
#define OW_BG_PAL_3 FALSE
#define OW_BG_PAL_4 FALSE
#define OW_BG_PAL_5 FALSE
#define OW_BG_PAL_6 FALSE
#define OW_BG_PAL_7 FALSE
#define OW_BG_PAL_8 FALSE
#define OW_BG_PAL_9 FALSE
#define OW_BG_PAL_10 FALSE
#define OW_BG_PAL_11 FALSE
#define OW_BG_PAL_12 FALSE
#define OW_BG_PAL_13 FALSE
#define OW_BG_PAL_14 FALSE
#define OW_BG_PAL_15 FALSE

#define OW_SPRITE_PAL_0 FALSE
#define OW_SPRITE_PAL_1 FALSE
#define OW_SPRITE_PAL_2 FALSE
#define OW_SPRITE_PAL_3 FALSE
#define OW_SPRITE_PAL_4 FALSE
#define OW_SPRITE_PAL_5 FALSE
#define OW_SPRITE_PAL_6 FALSE
#define OW_SPRITE_PAL_7 FALSE
#define OW_SPRITE_PAL_8 FALSE
#define OW_SPRITE_PAL_9 FALSE
#define OW_SPRITE_PAL_10 FALSE
#define OW_SPRITE_PAL_11 FALSE
#define OW_SPRITE_PAL_12 FALSE
#define OW_SPRITE_PAL_13 FALSE
#define OW_SPRITE_PAL_14 FALSE
#define OW_SPRITE_PAL_15 FALSE

//Battle Palettes
#define BBG_PAL_0 FALSE
#define BBG_PAL_1 FALSE
#define BBG_PAL_2 FALSE
#define BBG_PAL_3 FALSE
#define BBG_PAL_4 FALSE
