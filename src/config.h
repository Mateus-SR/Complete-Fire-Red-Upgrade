...
#define WILD_DOUBLE_RANDOM_CHANCE 35 //Change this to the percentage that a wild double battle will be initiated if the player is in special grass.
...
#define BIKE_ENCOUNTER_PERCENT 70 //Biking through grass or in caves only has this percentage of the encounter rate (vanilla FR is 80)
